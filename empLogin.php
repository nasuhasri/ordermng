               ...
               <div class="container">
                    <div class="row">
                         <div class="col-md-8 col-sm-12">
                              <div class="home-text">
                                   <article> 
                                        <h1 style="text-align:left">Staff Login</h1>
                                        <form action="empLoginAction.php" id="form" method="POST">                         
                                             <div class="container">
                                                  <h4 style="color:white" for="empID"><b>Staff ID</b></h4>
