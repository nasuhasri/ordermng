                              ...
                              <div class="home-text">
                                   <article> 
                                        <?php					
                                             ...
                                             $pwd = isset($_POST['supplierPassword']) ? $_POST['supplierPassword'] : '';

                                             //echo $id, $pwd;
                                        
                                             $sql="SELECT * FROM supplier WHERE supplierid='$id' and supppwd='$pwd'";
                                             ...
                                             if($result->num_rows>0)
                                             {
                                                  ...
                                                  {
                                                       $_SESSION['login_supplier']=$id;
                                                       
                                                       header("location:dashboardSupp.php");
                                                  }
                                             }
